...
import type { ScheduledGame, Strategy, Team, TeamSeasonRecord } from "../../domain/types";
import { PlayerAvatar } from "../components/Avatar";
import { TeamMark } from "../components/TeamMark";
import { ScreenHeader } from "../components/ScreenHeader";

export function PregameScreen({ team, opponent, lineup, strategy, game, teamRecord, opponentRecord, error, onBack, onSimulate }: { team: Team; opponent: Team; lineup: string[]; strategy: Strategy; game: ScheduledGame; teamRecord: TeamSeasonRecord; opponentRecord: TeamSeasonRecord; error: string | null; onBack: () => void; onSimulate: () => void }) {
  ...
  return <div className="screen-stack"><ScreenHeader eyebrow={`DAY ${game.day} · ${game.conferenceGame ? "CONFERENCE" : "NON-CONFERENCE"}`} title="Pregame" subtitle={`${userIsHome ? team.city : opponent.city} · 40 minutes · scheduled seed ${game.seed}`} onBack={onBack} />
